...
- [ ] F0: one eligible JD, Stage 0 through Stage 3, practice mode, unattended-or-not recorded | evidence: docs/loop/evidence/00-f0/stop.txt | verify: python -c "import json; print(json.load(open('data/loop_runs/f0/1uphealth/workflow_state.json',encoding='utf-8'))['status'])"
