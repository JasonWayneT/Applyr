...
F0 run in progress: `data/loop_runs/f0/1uphealth`, log `data/loop_runs/f0/1uphealth-run.log`. Practice mode, no --finalize until Stage 2 is COMPLETE. Do not write `data/submissions/` or the jobs database.
