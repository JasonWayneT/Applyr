...
| `FR-322` / `AC-420` | CR-112 | Hash-bound rubric score provenance; band-gated blind read; fail-closed disagreement | `scripts/contracts.py`, `scripts/workflow/runner.py`, `scripts/test_contracts.py`, `scripts/test_workflow_authority.py`; design `CR-112-score-provenance-design.md` | verified |
