...
**Status:** [ ] code landed 2026-09-10; pending review. WARN only
...
**Status:** [x] accepted locally on `cr112-story32` (2026-09-11). Independent review ACCEPT. Packet enum is `top2_cutoff` | `project_slot_cap`. TRACE holds scores, `score_zero`, and `boilerplate_filtered`. No push/merge.
...
**Status:** [x] accepted locally on `cr112-story33` (2026-09-11). Independent review ACCEPT. Synthetic traces only. No push/merge.
...
**Status:** [x] accepted locally on `cr112-story34` (2026-09-11). Independent review ACCEPT. Eligibility-framed skip only. No push/merge.
...
**Status:** [ ] code landed 2026-09-10; pending review. Unhandled name FAIL.
...
**Status:** [ ] code landed 2026-09-10; pending review. STATE-004 incomplete
...
**Status:** [ ] code landed 2026-09-10; pending review. STATE-001 named
...
**Status:** [ ] code landed 2026-09-10; pending review. Synthetic tests green.
...
**Status:** [ ] code landed 2026-09-10; pending review. Frozen sanitized set
...
**Status:** [ ] code landed 2026-09-10; pending review. `run_events.jsonl` on
