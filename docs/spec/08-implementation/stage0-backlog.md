...
- Stage 1 evidence-first authoring is CR-120 (`FR-348`–`FR-352`, `AC-451`–`AC-455`). Years-range keeps CR-117. Docs: `docs/spec/05-change-requests/CR-120-stage1-evidence-first-authoring.md`, `docs/spec/08-implementation/CR-120-stage1-evidence-first-authoring-epics.md`, `docs/spec/08-implementation/CR-120-blind-scorecard.md`, `docs/spec/08-implementation/RESEARCH-2026-09-18-stage1-authoring-shape.md`. Frozen cases stay in gitignored `data/eval/cr117/`; `scripts/freeze_cr117_cases.py` still verifies that folder.
