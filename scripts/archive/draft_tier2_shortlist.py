...
"""Force-draft tier-2 eval shortlist."""
...
DRAFTS = [
    ...
    },
    {
        "company": "Protege",
        "score": 72,
        "summary": "Tier 2 — ingestion/QA platform PM; data pipeline trust and catalog readiness.",
    },
    {
        "company": "Rhythm Energy",
        "score": 68,
        "summary": "Tier 2 — customer data PM; pipeline reliability and lifecycle metrics.",
    },
]
    ...
    for item in DRAFTS:
        ...
        try:
            run_drafting_engine(
                ...
                jd_text,
                work_exp,
                {"Score": item["score"], "Decision": "YES", "Summary": item["summary"]},
