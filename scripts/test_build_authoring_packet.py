...
class TestJdBucketsDedup(unittest.TestCase):
    ...
    def test_junk_is_not_a_culture_hook(self):
        buckets = _build_jd_buckets({
            "culture": ["Customer-obsessed culture"],
            "junk": ["Summary Generated by Built In"],
        })
        self.assertEqual(buckets["culture"], ["Customer-obsessed culture"])
        self.assertNotIn("junk", buckets)
        self.assertNotIn("Summary Generated by Built In", buckets["culture"])
