    ...
    <>
            ...
            <section>
              ...
              {loadingFiles ? (
                ...
                <div className="space-y-2">
                  ...
                  {/* Original JD text — viewable/editable, same as resume and cover letter */}
                  {files.some(f => f.name === 'Original_JD.txt') && (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          onClick={() => handleStartEdit('Original_JD.txt')}
                        ...
                        <a
                          href={api(`/api/jobs/${job.id}/files/${encodeURIComponent('Original_JD.txt')}`)}
      ...
      {editingFile && (
        <div className="fixed inset-0 z-50 bg-surface flex overflow-hidden animate-fade-in">
          ...
          {/* Right Pane: Toast UI rich document editor (50% width for .md, full width for .txt) */}
